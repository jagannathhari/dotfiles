...
hi Normal                     guifg=#CCCCCC guibg=#111111 gui=NONE      ctermfg=250 gui=italic
hi NonText                    guifg=#6A6A6A guibg=NONE    gui=NONE      ctermfg=008
hi Comment                    guifg=#555555 guibg=NONE    gui=NONE      ctermfg=243 gui=italic
hi Constant                   guifg=#40BDFF guibg=NONE    gui=NONE      ctermfg=039
hi Directory                  guifg=#40BDFF guibg=NONE    gui=NONE      ctermfg=039
hi Identifier                 guifg=#909090 guibg=NONE    gui=NONE      ctermfg=246
hi PreProc                    guifg=#909090 guibg=NONE    gui=NONE      ctermfg=246
...
hi String                     guifg=#5697B8 guibg=NONE    gui=NONE      ctermfg=039 gui=italic
...
hi CursorIM                   guifg=#111111 guibg=#CCCCCC gui=NONE      ctermfg=008   ctermbg=255
...
hi MatchParen                 guifg=#111111 guibg=#40BDFF gui=NONE      ctermfg=235   ctermbg=039
...
if s:accent == "red"
  ...
  hi MatchParen               guifg=#111111 guibg=#FF3D23 gui=NONE      ctermfg=235   ctermbg=001
  if s:invert_match_paren
...
if s:accent == "green"
  hi IncSearch                guifg=#111111 guibg=#65910F gui=NONE      ctermfg=255   ctermbg=002
  hi MatchParen               guifg=#111111 guibg=#87BF19 gui=NONE      ctermfg=235   ctermbg=002
  if s:invert_match_paren
    hi MatchParen             guifg=#87BF19 guibg=NONE    gui=NONE      ctermfg=002   ctermbg=NONE
  endif
  hi Search                   guifg=#111111 guibg=#87BF19 gui=NONE      ctermfg=235   ctermbg=002
endif

if s:accent == "yellow"
  hi IncSearch                guifg=#111111 guibg=#C3BA4D gui=NONE      ctermfg=255   ctermbg=226
  hi MatchParen               guifg=#111111 guibg=#DEDD5A gui=NONE      ctermfg=235   ctermbg=226
  if s:invert_match_paren
    hi MatchParen             guifg=#DEDD5A guibg=NONE    gui=NONE      ctermfg=226   ctermbg=NONE
  endif
  hi Search                   guifg=#111111 guibg=#DEDD5A gui=NONE      ctermfg=235   ctermbg=226
endif

if s:accent == "orange"
  hi IncSearch                guifg=#FFFFFF guibg=#FBBE1C gui=NONE      ctermfg=255   ctermbg=208
  hi MatchParen               guifg=#111111 guibg=#C88623 gui=NONE      ctermfg=235   ctermbg=208
  if s:invert_match_paren
...
if s:accent == "purple"
  ...
  hi MatchParen               guifg=#111111 guibg=#B294BB gui=NONE      ctermfg=235   ctermbg=013
  if s:invert_match_paren
...
hi Pmenu                      guifg=#EFEFEF guibg=#111111 gui=NONE      ctermfg=255   ctermbg=000
...
hi CursorLineNr               guifg=#DDDDDD guibg=#111111 gui=bold      ctermfg=255   ctermbg=NONE    cterm=bold
...
hi FoldColumn                 guifg=#111111 guibg=#40BDFF gui=NONE      ctermfg=235   ctermbg=039
hi Folded                     guifg=#111111 guibg=#40BDFF gui=NONE      ctermfg=235   ctermbg=039
hi LineNr                     guifg=#6A6A6A guibg=#111111 gui=NONE      ctermfg=245   ctermbg=NONE
...
hi WildMenu                   guifg=#111111 guibg=#40BDFF gui=NONE      ctermfg=235   ctermbg=039
...
if s:accent == "red"
  ...
  hi FoldColumn               guifg=#111111 guibg=#FF3D23 gui=NONE      ctermfg=235   ctermbg=001
  hi Folded                   guifg=#111111 guibg=#FF3D23 gui=NONE      ctermfg=235   ctermbg=001
  hi WildMenu                 guifg=#111111 guibg=#FF3D23 gui=NONE      ctermfg=235   ctermbg=001
  hi OverLength               guifg=NONE    guibg=#641900 gui=NONE      ctermfg=NONE  ctermbg=052
endif

if s:accent == "green"
  hi PmenuSel                 guifg=#111111 guibg=#87BF19 gui=NONE      ctermfg=235   ctermbg=002
  hi PmenuThumb               guifg=#111111 guibg=#87BF19 gui=NONE      ctermfg=235   ctermbg=002
  hi FoldColumn               guifg=#111111 guibg=#87BF19 gui=NONE      ctermfg=235   ctermbg=002
  hi Folded                   guifg=#111111 guibg=#87BF19 gui=NONE      ctermfg=235   ctermbg=002
  hi WildMenu                 guifg=#111111 guibg=#87BF19 gui=NONE      ctermfg=235   ctermbg=002
  hi OverLength               guifg=NONE    guibg=#32321E gui=NONE      ctermfg=NONE  ctermbg=022
endif

if s:accent == "yellow"
  hi PmenuSel                 guifg=#111111 guibg=#DEDD5A gui=NONE      ctermfg=235   ctermbg=226
  hi PmenuThumb               guifg=#111111 guibg=#DEDD5A gui=NONE      ctermfg=235   ctermbg=226
  hi FoldColumn               guifg=#111111 guibg=#DEDD5A gui=NONE      ctermfg=235   ctermbg=226
  hi Folded                   guifg=#111111 guibg=#DEDD5A gui=NONE      ctermfg=235   ctermbg=226
  hi WildMenu                 guifg=#111111 guibg=#DEDD5A gui=NONE      ctermfg=235   ctermbg=226
...
if s:accent == "orange"
  ...
  hi FoldColumn               guifg=#111111 guibg=#C88623 gui=NONE      ctermfg=235   ctermbg=208
  hi Folded                   guifg=#111111 guibg=#C88623 gui=NONE      ctermfg=235   ctermbg=208
  hi WildMenu                 guifg=#111111 guibg=#C88623 gui=NONE      ctermfg=235   ctermbg=208
  hi OverLength               guifg=NONE    guibg=#443A16 gui=NONE      ctermfg=NONE  ctermbg=094
endif

if s:accent == "purple"
  hi PmenuSel                 guifg=#111111 guibg=#B294BB gui=NONE      ctermfg=235   ctermbg=013
  hi PmenuThumb               guifg=#111111 guibg=#B294BB gui=NONE      ctermfg=235   ctermbg=013
  hi FoldColumn               guifg=#111111 guibg=#B294BB gui=NONE      ctermfg=235   ctermbg=013
  hi Folded                   guifg=#111111 guibg=#B294BB gui=NONE      ctermfg=235   ctermbg=013
  hi WildMenu                 guifg=#111111 guibg=#B294BB gui=NONE      ctermfg=235   ctermbg=013
